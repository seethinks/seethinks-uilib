package com.hezi.uilib.threedcomponents 
{
	...
	*/
	public class AbstractComponentBase extends Plane implements IbComponent 
	{
		...
		public function AbstractComponentBase() 
		{
			...
			var unimplemented:Array = [destroy,draw3D,init,setLocation,setSize,setStyle,getStyle];   // 抽象方法数组
