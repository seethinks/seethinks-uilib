...
List<Widget> initChilder(List<BeeActionsheetItem> childer, onChange,
    Color borderColor, TextStyle actionsheetOptionsStyle,
                ...
                child: SizedBox(
                    child: Padding(
                        ...
                        child: DefaultTextStyle(
                            style: TextStyle(
                                fontSize: 16.0, color: Colors.black).merge(
