	...
	*/
	public class StToggleButton extends AbstractComponentBase
	{
		...
		override public function init():void 
		{
			...
			if (_skinObj)
			{
				if (_skinObj[SkinStyle.TOGGLEBUTTON_DEFAULT])
				{
					tempObj = _skinObj[SkinStyle.TOGGLEBUTTON_DEFAULT];
				}else
				{
					tempObj = SkinStyle.Skin.SkinObj[SkinStyle.TOGGLEBUTTON_DEFAULT];
				}
			}else
			{
				tempObj = SkinStyle.Skin.SkinObj[SkinStyle.TOGGLEBUTTON_DEFAULT];
			...
			if (tempObj)
			{
				if (parentType.indexOf("BitmapAsset") !=-1)
				{
					...
					_styleMap[SkinStyle.TOGGLEBUTTON_DEFAULT] = tempSpr;
				...
				{
					_styleMap[SkinStyle.TOGGLEBUTTON_DEFAULT] = SkinStyle.duplicateDisplayObject(tempObj) as Sprite;
				}else
				{
					throw new UiLibError(UiLibError.VALUE_TYPEERROR_MSG, StToggleButton, "参数应该为图类型,应继承自[BitmapAsset,BitmapData,SpriteAsset]");
				}
			}
			...
			if (_skinObj)
			{
				if (_skinObj[SkinStyle.TOGGLEBUTTON_ROLLOVER])
				{
					tempObj = _skinObj[SkinStyle.TOGGLEBUTTON_ROLLOVER];
				}else
				{
					tempObj = SkinStyle.Skin.SkinObj[SkinStyle.TOGGLEBUTTON_ROLLOVER];
				}
			}else
			{
				tempObj = SkinStyle.Skin.SkinObj[SkinStyle.TOGGLEBUTTON_ROLLOVER];
			...
			if (tempObj)
			{
				if (parentType.indexOf("BitmapAsset") !=-1)
				{
					...
					tempSpr = new Sprite();
					tempSpr.addChild(new Bitmap(tempBmp.bitmapData.clone()));
					_styleMap[SkinStyle.TOGGLEBUTTON_ROLLOVER] = tempSpr;
				}else if (parentType.indexOf("BitmapData") !=-1)
				{
					tempSpr = new Sprite();
					tempSpr.addChild(new Bitmap(BitmapData(tempObj).clone()));
				...
				{
					_styleMap[SkinStyle.TOGGLEBUTTON_ROLLOVER] = SkinStyle.duplicateDisplayObject(tempObj) as Sprite;
				}else
				{
					throw new UiLibError(UiLibError.VALUE_TYPEERROR_MSG, StToggleButton, "参数应该为图类型,应继承自[BitmapAsset,BitmapData,SpriteAsset]");
				}
			...
			if (_skinObj)
			{
				if (_skinObj[SkinStyle.TOGGLEBUTTON_PRESS])
				{
					tempObj = _skinObj[SkinStyle.TOGGLEBUTTON_PRESS];
				}else
				{
					tempObj = SkinStyle.Skin.SkinObj[SkinStyle.TOGGLEBUTTON_PRESS];
				}
			}else
			{
				tempObj = SkinStyle.Skin.SkinObj[SkinStyle.TOGGLEBUTTON_PRESS];
			...
			if (tempObj)
			{
				if (parentType.indexOf("BitmapAsset") !=-1)
				{
					...
					tempSpr = new Sprite();
					tempSpr.addChild(new Bitmap(tempBmp.bitmapData.clone()));
					_styleMap[SkinStyle.TOGGLEBUTTON_PRESS] = tempSpr;
				}else if (parentType.indexOf("BitmapData") !=-1)
				{
					tempSpr = new Sprite();
					tempSpr.addChild(new Bitmap(BitmapData(tempObj).clone()));
				...
				{
					_styleMap[SkinStyle.TOGGLEBUTTON_PRESS] = SkinStyle.duplicateDisplayObject(tempObj) as Sprite;
				}else
				{
					throw new UiLibError(UiLibError.VALUE_TYPEERROR_MSG, StToggleButton, "参数应该为图类型,应继承自[BitmapAsset,BitmapData,SpriteAsset]");
				}
			...
			if (_skinObj)
			{
				if (_skinObj[SkinStyle.TOGGLEBUTTON_DISABLE])
				{
					tempObj = _skinObj[SkinStyle.TOGGLEBUTTON_DISABLE];
				}else
				{
					tempObj = SkinStyle.Skin.SkinObj[SkinStyle.TOGGLEBUTTON_DISABLE];
				}
			}else
			{
				tempObj = SkinStyle.Skin.SkinObj[SkinStyle.TOGGLEBUTTON_DISABLE];
			...
			if (tempObj)
			{
				if (parentType.indexOf("BitmapAsset") !=-1)
				{
					...
					tempSpr = new Sprite();
					tempSpr.addChild(new Bitmap(tempBmp.bitmapData.clone()));
					_styleMap[SkinStyle.TOGGLEBUTTON_DISABLE] = tempSpr;
				}else if (parentType.indexOf("BitmapData") !=-1)
				{
					tempSpr = new Sprite();
					tempSpr.addChild(new Bitmap(BitmapData(tempObj).clone()));
				...
				{
					_styleMap[SkinStyle.TOGGLEBUTTON_DISABLE] = SkinStyle.duplicateDisplayObject(tempObj) as Sprite;
				}else
				{
					throw new UiLibError(UiLibError.VALUE_TYPEERROR_MSG, StToggleButton, "参数应该为图类型,应继承自[BitmapAsset,BitmapData,SpriteAsset]");
				}
		...
		override public function setStyle(styleName:String = "", styleObj:Object = null):void 
		{
			...
			{
				throw new UiLibError(UiLibError.VALUE_TYPEERROR_MSG, StToggleButton, "图形参数应该继承自[BitmapAsset,BitmapData,SpriteAsset],文本参数应该为String");
			}*/
		...
		override public function draw():void 
		{
			...
			_defaultSpr = _styleMap[SkinStyle.TOGGLEBUTTON_DEFAULT] as Sprite;
			_rollOverSpr = _styleMap[SkinStyle.TOGGLEBUTTON_ROLLOVER] as Sprite;
			_pressSpr = _styleMap[SkinStyle.TOGGLEBUTTON_PRESS] as Sprite;
			_disableSpr = _styleMap[SkinStyle.TOGGLEBUTTON_DISABLE] as Sprite;
			addChild(_labelBmp);
		...
		{
			return (_curStatues == TOGGLEBUTTON_STATUS_DEFAULT?false:true);
		}
