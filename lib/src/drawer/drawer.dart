...
// 方向
enum BeeModalPlacement { top, right, bottom, left }

class DrawerWidget extends StatefulWidget {
  final BeeModalPlacement placement;
  final Widget child;
  final bool mask;
...
class DrawerWidgetState extends State<DrawerWidget>
  ...
  void initState() {
    ...
    super.initState();
    // 判断方向
    isVertical = [BeeModalPlacement.top, BeeModalPlacement.bottom]
  ...
  void initAnimation() {
    ...
    switch (widget.placement) {
      case BeeModalPlacement.top:
      case BeeModalPlacement.left:
        begin = -size;
        break;
      case BeeModalPlacement.right:
      case BeeModalPlacement.bottom:
        begin = size;
        break;
    }
        ...
        builder: (BuildContext context, Widget child) {
          ...
          final List<Widget> children = [
            Positioned(
                top: top,
                right: right,
                bottom: MediaQuery.of(context).viewInsets.bottom,// 底部是输入框的时候自动跟随键盘
                left: left,
